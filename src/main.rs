...
fn main() {
    ...
    .subcommand(
        ...
        .arg(Arg::with_name("path").long("path").short("p").case_insensitive(true).takes_value(true).required(true).help("Path to USB stick. Used to store saved packages. You can drag and drop the root folder from your flash drive")))
        .subcommand(
            SubCommand::with_name("install")
            .about("install all packages to your live install").arg(Arg::with_name("path").long("path").short("p").case_insensitive(true).takes_value(true).required(true).help("Path to USB stick. Used to store saved packages. You can drag and drop the root folder from your flash drive")))
            .get_matches();
